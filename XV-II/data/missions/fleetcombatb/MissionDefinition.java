package data.missions.fleetcombatb;
...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.initFleet(FleetSide.PLAYER, "ZXU", FleetGoal.ATTACK, false, 9);
		api.initFleet(FleetSide.ENEMY, "TTS", FleetGoal.ATTACK, true, 164);

		// Set a small blurb for each fleet that shows up on the mission detail and
		// mission results screens to identify each side.
		api.setFleetTagline(FleetSide.PLAYER, "A small but highly-advanced fleet");
		api.setFleetTagline(FleetSide.ENEMY, "An even larger fleet");
		
		// These show up as items in the bulleted list under 
		// "Tactical Objectives" on the mission detail screen
		api.addBriefingItem("Defeat all enemy forces");
		api.addBriefingItem("Your super battleship must survive");
		
		// Set up the player's fleet.  Variant names come from the
		// files in data/variants and data/variants/fighters
		api.addToFleet(FleetSide.PLAYER, "eszvcorva_Standard", FleetMemberType.SHIP, "ZXU Evalavca", true);
		api.addToFleet(FleetSide.PLAYER, "azorva_standard", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.RECKLESS);
		api.addToFleet(FleetSide.PLAYER, "revlogvortora_standard", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.AGGRESSIVE);
		api.addToFleet(FleetSide.PLAYER, "revlogvortora_standard", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.AGGRESSIVE);
		api.addToFleet(FleetSide.PLAYER, "revlogvortora_standard", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.AGGRESSIVE);
		api.addToFleet(FleetSide.PLAYER, "azorva_standard", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.RECKLESS);
		api.addToFleet(FleetSide.PLAYER, "azorva_standard", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.RECKLESS);
		api.addToFleet(FleetSide.PLAYER, "orkovtrva_advanced", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.TIMID);
		api.addToFleet(FleetSide.PLAYER, "orkovtrva_advanced", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.TIMID);
		api.addToFleet(FleetSide.PLAYER, "orkovtrva_advanced", FleetMemberType.SHIP, false).getCaptain().setPersonality(Personalities.TIMID);
		...
		api.defeatOnShipLoss("ZXU Evalavca");
		...
		api.addToFleet(FleetSide.ENEMY, "astral_Elite", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "astral_Elite", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "azorva_standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "azorva_standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "azorva_standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "azorva_standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "azorva_standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "azorva_standard", FleetMemberType.SHIP, false);
		api.addToFleet(FleetSide.ENEMY, "orkovtrva_advanced", FleetMemberType.SHIP, false);
